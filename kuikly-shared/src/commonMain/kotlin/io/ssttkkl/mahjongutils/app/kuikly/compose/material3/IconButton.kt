...
import com.tencent.kuikly.compose.material3.fromToken
...
import com.tencent.kuikly.compose.material3.tokens.FilledIconButtonTokens
import com.tencent.kuikly.compose.material3.tokens.FilledTonalIconButtonTokens
import com.tencent.kuikly.compose.material3.tokens.IconButtonTokens
import com.tencent.kuikly.compose.material3.tokens.OutlinedIconButtonTokens
...
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultFilledIconButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultFilledIconToggleButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultFilledTonalIconButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultFilledTonalIconToggleButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultIconButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultIconToggleButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultOutlinedIconButtonColorsCached
import io.ssttkkl.mahjongutils.app.kuikly.compose.material3.ColorSchemeCache.defaultOutlinedIconToggleButtonColorsCached
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/standard-icon-button.png)
 *
 * [content] should typically be an [Icon] (see [com.tencent.kuikly.compose.material.icons.Icons]). If using a
 ...
 * Simple Usage
 *
 * @sample com.tencent.kuikly.compose.material3.samples.IconButtonSample
 * IconButton with a color tint
 *
 * @sample com.tencent.kuikly.compose.material3.samples.TintedIconButtonSample
 *
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/standard-icon-toggle-button.png)
 *
 * [content] should typically be an [Icon] (see [com.tencent.kuikly.compose.material.icons.Icons]). If using a
 * custom icon, note that the typical size for the internal icon is 24 x 24 dp. This icon button has
 * an overall minimum touch target size of 48 x 48dp, to meet accessibility guidelines.
 *
 * @sample com.tencent.kuikly.compose.material3.samples.IconToggleButtonSample
 *
 ...
 *
 * ![Filled icon button
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/filled-icon-button.png)
 *
 * [content] should typically be an [Icon] (see [com.tencent.kuikly.compose.material.icons.Icons]). If using a
 * custom icon, note that the typical size for the internal icon is 24 x 24 dp. This icon button has
 * an overall minimum touch target size of 48 x 48dp, to meet accessibility guidelines.
 ...
 *
 * @sample com.tencent.kuikly.compose.material3.samples.FilledIconButtonSample
 *
 * @param onClick called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
 * @param enabled controls the enabled state of this icon button. When `false`, this component will
...
fun FilledIconButton(
    ...
    Surface(
        ...
        Box(
            modifier =
                Modifier.size(
                    width = 40.0.dp, // FilledIconButtonTokens.ContainerWidth,
                    height = 40.0.dp // FilledIconButtonTokens.ContainerHeight
                ),
            contentAlignment = Alignment.Center
        ) {
            content()
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/filled-tonal-icon-button.png)
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.material3.samples.FilledTonalIconButtonSample
 *
 * @param onClick called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
 * @param enabled controls the enabled state of this icon button. When `false`, this component will
...
fun FilledTonalIconButton(
    ...
    Surface(
        ...
        Box(
            modifier =
                Modifier.size(
                    width = 40.dp, // FilledTonalIconButtonTokens.ContainerWidth,
                    height = 40.dp // FilledTonalIconButtonTokens.ContainerHeight
                ),
            contentAlignment = Alignment.Center
        ) {
            content()
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/filled-icon-toggle-button.png)
 *
 * [content] should typically be an [Icon] (see [com.tencent.kuikly.compose.material.icons.Icons]). If using a
 * custom icon, note that the typical size for the internal icon is 24 x 24 dp. This icon button has
 * an overall minimum touch target size of 48 x 48dp, to meet accessibility guidelines.
 ...
 *
 * @sample com.tencent.kuikly.compose.material3.samples.FilledIconToggleButtonSample
 *
 * @param checked whether this icon button is toggled on or off
 * @param onCheckedChange called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/filled-tonal-icon-toggle-button.png)
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.material3.samples.FilledTonalIconToggleButtonSample
 *
 * @param checked whether this icon button is toggled on or off
 * @param onCheckedChange called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/outlined-icon-button.png)
 *
 * Icon buttons help people take supplementary actions with a single tap. They’re used when a
 * compact button is required, such as in a toolbar or image list.
 *
 ...
 *
 * @sample com.tencent.kuikly.compose.material3.samples.OutlinedIconButtonSample
 *
 * @param onClick called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
 * @param enabled controls the enabled state of this icon button. When `false`, this component will
 ...
 * image](https://developer.android.com/images/reference/com.tencent.kuikly/compose/material3/outlined-icon-toggle-button.png)
 *
 * [content] should typically be an [Icon] (see [com.tencent.kuikly.compose.material.icons.Icons]). If using a
 * custom icon, note that the typical size for the internal icon is 24 x 24 dp. This icon button has
 * an overall minimum touch target size of 48 x 48dp, to meet accessibility guidelines.
 *
 * @sample com.tencent.kuikly.compose.material3.samples.OutlinedIconToggleButtonSample
 *
 * @param checked whether this icon button is toggled on or off
 * @param onCheckedChange called when this icon button is clicked
 * @param modifier the [Modifier] to be applied to this icon button
